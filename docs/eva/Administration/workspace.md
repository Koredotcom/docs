...
* Simple creation process through the **Account Hub**.
...
For more information on Workspace Creation, refer [Create a Workspace](../workspace-management/account-workspace#create-a-workspace.md)
