...
| userId                | Allows you to search for logs related to a specific user.                                                                                                                      | Yes           | “userId=example” : Returns logs of all actions performed by the user with ID 'example'.                                                             |
| emailId               | Allows you to search for actions tied to a particular email address                                                                                                            | Yes           | “emailId=example@kore.com” : Returns logs related to actions performed by the user associated with the email example@kore.com               |
