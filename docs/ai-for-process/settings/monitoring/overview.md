...
2. **Workflow Analytics Dashboard**: Empowers admins to make informed decisions on workflows deployed in their account, and ensure their peak performance by analyzing real-time performance metrics. [Learn more](./analytics/tools-analytics-dashboard.md){:target="_blank"}.
