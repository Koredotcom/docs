...
1. [Sign in](../getting-started/sign-up-sign-in.md){:target="_blank"} to your AI for Process account. To enable and sign in via SSO, click [here](../settings/security-and-control/single-sign-on.md){:target="_blank"}.
