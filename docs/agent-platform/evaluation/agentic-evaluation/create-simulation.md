...
* **Write a test scenario** – Manually define details such as the user query, context, and expected output.
...
### Option 1: Write a test scenario
...
### Option 2: Generate test scenarios
...
**Note**: A new simulations can be re-triggered anytime after updating existing personas, scenarios, or agent logic.
