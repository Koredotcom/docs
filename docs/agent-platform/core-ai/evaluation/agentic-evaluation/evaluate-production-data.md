...
3. Select the appropriate configuration for the evaluator and click **Save**.
...
4. Click **Run Evaluation** to start the analysis.
...
* **Message Tonality**: Evaluates whether the conversation maintained an appropriate and consistent tone (e.g., professional, friendly).
