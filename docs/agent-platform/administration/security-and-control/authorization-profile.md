...
2. [Navigate](https://docs.kore.ai/agent-platform/administration/settings-overview/#access-settings-console){:target="_blank"} to the **Settings** console.
...
<li>Provide the values for the mandatory OAuth2 authorization fields. For details, refer to the <a href="https://docs.kore.ai/agent-platform/administration/security-and-control/authorization-profile/#define-authorization-fields" target="_blank">Define Authorization Fields</a> section. 
...
<li>(Optional) Click <b>+ Add Additional Field</b> to add additional fields for authentication. See the <a href="https://docs.kore.ai/agent-platform/administration/security-and-control/authorization-profile/#add-additional-field" target="_blank">Add Additional Field</a> section.</li></ol>
...
<ol start="7"><li>(Optional) Click <b>+ Add Authorization Field</b> to add additional auth fields to your profile. For more information, see the <a href="https://docs.kore.ai/agent-platform/administration/security-and-control/authorization-profile/#add-authorization-field" target="_blank">Add Authorization Field</a> section.</li>
...
Example: <code>read_profile</code>.
  ...
  <tr>
   ...
   <td>
    Refer <a href="https://docs.kore.ai/agent-platform/administration/security-and-control/authorization-profile/#add-additional-field" target="_blank">here</a>.
   </td>
   <td>Optional
   </td>
  </tr>
  <tr>
   ...
   <td>
    Refer <a href="https://docs.kore.ai/agent-platform/administration/security-and-control/authorization-profile/#add-authorization-field" target="_blank">here</a>.</td>
   <td>Optional
   </td>
  </tr>
  <tr>
