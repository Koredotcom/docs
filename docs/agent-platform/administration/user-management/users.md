...
<p>The imported users are assigned the <b>Viewer</b> system role by default, which you can change. <a href="https://docs.kore.ai/agent-platform/administration/user-management/role-management/#system-defined-roles" target="_blank">Learn more</a>.</p>
</div>
