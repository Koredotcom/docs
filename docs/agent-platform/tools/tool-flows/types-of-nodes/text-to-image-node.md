...
3. Click **Save**. [Learn more](https://docs.kore.ai/agent-platform/tools/tool-flows/types-of-nodes/gen-ai-node/#access-the-gen-ai-nodes-output){:target="_blank"} about accessing the node’s output.
