...
If you've already set up AI for Service, your existing and shared workspaces will both be visible, but you'll need separate access permission from workspace owners to use shared workspaces in the Agent Platform. [Learn more](../../getting-started/sign-up-sign-in.md){:target="_blank"}.
