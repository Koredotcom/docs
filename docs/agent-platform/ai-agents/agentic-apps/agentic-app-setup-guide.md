...
1. **Sign Up for the Agent Platform**: The Platform onboarding journey starts with creating an account. Upon successful signup, the platform automatically provision a dedicated workspace for your projects.</br>
  If you've already set up (In)Business Customer Experience, your existing and shared workspaces are visible, but you need separate access permission from workspace owners to use shared workspaces in the Platform.
