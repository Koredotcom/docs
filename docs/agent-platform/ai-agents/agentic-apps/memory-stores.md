...
The **metadata** field is used to maintain any contextual metadata information. Developers can update this field only via the APIs or while accessing the platform via (In)Business Customer Experience or (In)Business Productivity.
