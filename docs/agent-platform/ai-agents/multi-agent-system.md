...
* **AI Agents**: Autonomous, task-focused software entities that perform specific functions. They're the building blocks of agentic apps. [Learn more](./overview.md).
