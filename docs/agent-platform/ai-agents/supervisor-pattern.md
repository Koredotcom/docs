...
[Learn more](./../ai-agents/agentic-apps/agentic-app-overview.md) - how this pattern is used for orchestrating multiple AI Agents using Agentic Apps by the Agent Platform.
