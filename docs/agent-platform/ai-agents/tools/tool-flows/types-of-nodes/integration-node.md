...
<p><ul><li>A service provider account and connection to it must exist before you configure a node. If no connection is available, the system will prompt you to add one.</li>
