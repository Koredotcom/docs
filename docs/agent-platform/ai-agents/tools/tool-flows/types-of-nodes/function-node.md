...
<p>The deployed scripts are listed under <b>Settings</b> > <b>Manage custom scripts</b>. <a href="../../../../settings/manage-custom-scripts/custom-scripts.md" target="_blank">Learn more</a>.</p>
</div>
...
<div class="admonition note">
<p class="admonition-title">Important</p>
<p><ul><li>You can use the <b>Start</b> node’s input variables as context variables in the script editor to accept dynamic values and generate the output. To refer to the input variable, follow the syntax mentioned <a href="../types-of-nodes/function-node.md/#syntaxes-for-the-context-input" target="_blank">here</a>.</li>
