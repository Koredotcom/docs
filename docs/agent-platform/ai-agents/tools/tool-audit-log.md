...
5. Click each row to view more details about the event. For more information, see Tool-Level Audit Logs. [Learn more](../../settings/monitoring/audit-logs.md/#tool-level-audit-logs){:target="_blank"}.
