...
<table>
  ...
  <tr><td><a href="../apis-list/undeploy-a-model/">Undeploy a Model API</a></td>
   <td>To undeploy a model from the environment.</td>
  </tr>
  <tr><td rowspan="2"><b>Manage Guardrails</b></td>
    <td><a href="../apis-list/deploy-guardrails/">Deploy Guardrails API</a></td>
   <td>To deploy predefined guardrails into the system.</td></tr>
   <tr><td><a href="../apis-list/undeploy-guardrails/">Undeploy Guardrails API</a></td>
