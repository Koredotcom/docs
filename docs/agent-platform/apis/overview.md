...
|---------------------|------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| File Management     | [File Upload API](../apis-list/upload-file-api/)                                          | To upload a small or large public file in the allowed format.                                                                                                                                                                     |
| View Process Status | [Get Dock Status API](../apis-list/get-dock-status/)                                      | To check the status of an ongoing or completed job related to tools or models.                                                                                                                                                    |
| Manage a Tool       | [Import a New Tool API](../apis-list/import-a-new-tool/)                                  | To import a new tool into the system.                                                                                                                                                                                             |
|                     | [Import to an Existing Tool API](../apis-list/import-to-an-existing-tool)                | To import new configurations, datasets, or updates into an already existing tool within the system.                                                                                                                               |
|                     | [Export a Tool API](../apis-list/export-a-tool)                                          | To export an existing tool's configuration and associated data, including its flow, for backup, sharing, or reuse.                                                                                                                |
|                     | [Deploy a Tool API](../apis-list/deploy-a-tool)                                          | To deploy a specific tool into an environment.                                                                                                                                                                                     |
|                     | [Undeploy a Tool API](../apis-list/undeploy-a-tool)                                      | To undeploy a specific tool from an environment.                                                                                                                                                                                   |
| Manage a Model      | [Import a Model API](../apis-list/import-a-model)                                        | Import a model in chunks into the system.                                                                                                                                                                                          |
|                     | [Export a Model API](../apis-list/export-a-model)                                        | To export a trained AI model from the system.                                                                                                                                                                                      |
|                     | [Deploy a Model API](../apis-list/deploy-a-model)                                        | To deploy a model into the environment in the *Ready to Deploy* state and configure its parameters. The initial deployment must be done manually in the Agent Platform account. Consecutive deployments must happen via the public API. |
|                     | [Undeploy a Model API](../apis-list/undeploy-a-model)                                    | To undeploy a model from the environment.                                                                                                                                                                                          |
| Manage Guardrails   | [Deploy Guardrails API](../apis-list/deploy-guardrails)                                  | To deploy predefined guardrails into the system.                                                                                                                                                                                   |
|                     | [Undeploy Guardrails API](../apis-list/undeploy-guardrails)                              | To undeploy predefined guardrails from the system.                                                                                                                                                                                 |
