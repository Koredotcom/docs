...
* **External models**: Add commercial models like OpenAI, Anthropic, Azure OpenAI, Cohere, and Google. You can also integrate your own hosted models into (In)Agent Platform using API connections. [Learn more](../models/external-models/add-an-external-model-using-easy-integration.md).
...
1. Log in to your (In)Agent Platform account and click **Model hub** under **(In)Agent Platform Modules**.
