...
(In)Agent Platform supports the following optimization types: CTranslate2 and vLLM.

!!! note

    The model optimization is supported only for the Inception-hosted models.
