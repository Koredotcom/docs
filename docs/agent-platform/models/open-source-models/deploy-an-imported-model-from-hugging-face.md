...
!!! note
    ...
    (In)Agent Platform currently supports models compatible with Transformers library version lower than or equal to 4.43.1. Models that require a higher version of the Transformers library cannot be supported in (In)Agent Platform at this time.
