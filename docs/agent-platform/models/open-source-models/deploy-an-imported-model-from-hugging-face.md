...
1. In the **Import** model section:
    ...
    * Select the **Hugging Face connection to use** from the drop-down list.  For more information about enabling your Hugging Face account, see [How to Connect to your Hugging Face Account](../administration/settings/integrations/enable-hugging-face.md).
