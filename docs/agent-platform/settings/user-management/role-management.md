...
<strong> </strong>
   ...
   <td><img src="../images/yes-icon.png" alt="access role management" title="access role management" style="zoom:6.5%;">
   </td>
   <td><img src="../images/yes-icon.png" alt="access role management" title="access role management" style="zoom:6.5%;"></td>
   <td><img src="../images/yes-icon.png" alt="access role management" title="access role management" style="zoom:6.5%;"></td>
   <td><img src="../images/no-icon.png" alt="access role management" title="access role management" style="zoom:6.5%;"></td>
  </tr>
  <tr>
     <td>Tool Import
   </td>
   ...
   <td><img src="../images/yes-icon.png" alt="access role management" title="access role management" style="zoom:6.5%;"></td>
   <td><img src="../images/yes-icon.png" alt="access role management" title="access role management" style="zoom:6.5%;"></td>
   <td><img src="../images/no-icon.png" alt="access role management" title="access role management" style="zoom:6.5%;">
   </td>
  </tr>
  <tr>
