...
Agent Platform’s **Role Management** feature in the **Settings** console helps implement Role-based Access Control (RBAC) for both account and agent features on the platform. 
...
The following Role Types are defined on Agent Platform:
...
<p>
  ...
  <tr>
   <td>Monitor agents and models on the Agent Platform level
   </td>
   <td>Yes
   </td>
   <td>Yes
