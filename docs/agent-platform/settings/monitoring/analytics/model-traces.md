...
<li><strong>Tool</strong>: The request was sent to the model from a tool. <a href="../../../ai-agents/tools/overview.md" target="_blank">Learn more</a>.</li>

<li><strong>Prompts</strong>: The request was sent to the model from a Prompt experiment. <a href="../../../prompts/using-prompt-studio.md" target="_blank">Learn more</a>.</li>

<li><strong>API Key</strong>: The request was sent to the (open-source) model using an API key. <a href="../../../models/open-source-models/generate-an-api-key-open-source.md" target="_blank">Learn more</a>.</li>
</ul>
   </td>
  </tr>
  <tr>
