...
**LLMs**: Agents use LLMs to understand the intent and interpret user queries, interact with users, fetch required entities to complete a task, and design the workflow to execute a series of actions. 