...
**Web Client Details**: Use the URL hosted by the agent platform to start interacting with the app. 
...
API Keys are required to authenticate the requests sent to the Agentic App. Follow the steps to create a new API Key. 
