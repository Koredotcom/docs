...
To associate the agentic application with a knowledge tool, open the application and navigate to the **Knowledge** page. This page displays all existing Knowledge Tools in the agentic app.
   ...
   <img src="../images/create-a-knowledge-tool.png" alt="Create a Knowledge Tool" title="Create a Knowledge Tool" style="border: 1px solid gray; zoom:90%;">
...
On the following page, provide the configuration details of the Knowledge Tool.
   ...
   <img src="../images/create-a-knowledge-tool.png" alt="Create from existing sources" title="Create from existing sources" style="border: 1px solid gray; zoom:90%;">
...
**Knowledge Sources** - Click **Link Knowledge Source** to view all the Search AI applications in the same workspace as that of the Agentic App which are accessible.
   ...
   <img src="../images/knowledge-sources.png" alt="Knowledge Sources" title="Knowledge Sources" style="border: 1px solid gray; zoom:90%;">
...
You can update content or modify configurations at any time by navigating to the associated Search AI application.
   ...
   <img src="../images/complete-the-integration.png" alt="complete the integration" title="complete the integration" style="border: 1px solid gray; zoom:90%;">

### Create from Scratch

On the **Knowledge** page, select **Create from Scratch** from the dropdown menu. Enter the following details.

   <img src="../images/create-from-scratch.png" alt="Create from Scratch" title="Create from Scratch" style="border: 1px solid gray; zoom:90%;">
