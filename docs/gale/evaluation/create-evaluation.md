...
**Evaluations: The Core of the Project**
...
Note: An additional folder of evaluations under projects helps remove the pain of renaming an uploaded dataset according to the evaluation use case. Users can simply name the evaluation itself. 
...
6. On the Evaluation’s landing page, click the three dots icon in the row of the evaluation you want to manage for the following options:
...
* The ‘Evaluation’ section acts as a container or folder, organizing datasets within a project. 
