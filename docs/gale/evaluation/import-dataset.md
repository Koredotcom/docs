...
Evaluation Studio provides a flexible approach for importing and managing datasets, making it easier to evaluate model outputs.

 Users can upload datasets in CSV format. These datasets may contain:
