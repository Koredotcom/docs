...
1. Hover over <**Account** name>> from the pop-up list and click the **Invite user to the account** option from the list as shown below.
...
2. Enter the **Email ID** of the user to add to the account and click **Invite**.
