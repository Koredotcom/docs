...
* The ***to*** key in the request payload must be a valid user email Id, and it should be singular in the initial implementation.
* ***actions*** in the request payload will be transmitted to users as buttons for input.