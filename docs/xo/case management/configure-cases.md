...
1. Access case management **Fields** by navigating to **Contact Center AI** > **Case Management** > **Configuration** > **Fields**.
    ...
    <img src="../case management/images/config-fields.png" alt="Fields" title="Fields" style="border: 1px solid gray; zoom:70%;">
...
1. On the **Fields** page, click **+ New Field**. 
    ...
    <img src="../case management/images/new-field-create.png" alt="New Field" title="New Field" style="border: 1px solid gray; zoom:70%;">

2. On the **New Field** page, complete the **General Settings** sections sequence.

    <img src="../case management/images/general-settings.png" alt="General Settings" title="General Settings" style="border: 1px solid gray; zoom:70%;">
...
1. In the **Data Settings**, add the **Default Value** (based on the field format), and click **Save**. 
    ...
    <img src="../case management/images/data-settings.png" alt="Data Settings" title="Data Settings" style="border: 1px solid gray; zoom:70%;">
...
<img src="../case management/images/validation-settings.png" alt="Validation Settings" title="Validation Settings" style="border: 1px solid gray; zoom:70%;">
...
1. On the **Fields** page, click the vertical ellipsis (<img src="../case management/images/ellipsis-icon.png" style="zoom:50%;"></img>) button to edit the Custom fields added. 

    <img src="../case management/images/edit-fields.png" alt="Edit Fields" title="Edit Fields" style="border: 1px solid gray; zoom:70%;">
...
2. Click **Edit** to open the edit **Field** page.
    ...
    <img src="../case management/images/edit-field-page.png" alt="Edit Field Page" title="Edit Field Page" style="border: 1px solid gray; zoom:70%;">
...
1. On the **Fields** page, click the vertical ellipsis (<img src="../case management/images/ellipsis-icon.png" style="zoom:50%;"></img>) button to delete the required fields.

    <img src="../case management/images/delete-fileds.png" alt="Delete Field Page" title="Delete Field Page" style="border: 1px solid gray; zoom:70%;">

2. Select **Delete** to confirm. the following warning pop-up dialog box appears.
    
    <img src="../case management/images/delete-confirm.png" alt="Delete Warning" title="Delete Warning" style="border: 1px solid gray; zoom:70%;">
...
<img src="../case management/images/task-templates.png" alt="Task Templates" title="Task Templates" style="border: 1px solid gray; zoom:70%;">
...
1. On the **Task Templates** page, click **+ New Task Template**. 
    ...
    <img src="../case management/images/task-templates.png" alt="New Task Templates" title="New Task Templates" style="border: 1px solid gray; zoom:70%;">
...
2. On the following **New Task Template** page, complete the **Basic Information** section sequence.
    ...
    <img src="../case management/images/new-task-template-basic-info.png" alt="New Task Template Basic Info" title="New Task Template Basic Info" style="border: 1px solid gray; zoom:70%;">
...
3. Based on your preferences, you can choose the following **Default Assignee** options provided:
    ...
    * **Unassigned**: By default, when a case is created with this configuration, it is not assigned to any individual.
        ...
        <img src="../case management/images/default-assignee-unassigned.png" alt="Unassigned" title="Unassigned" style="border: 1px solid gray; zoom:70%;">
    ...
    * **Queues**: As an administrator, you can create custom queues for agents to handle specific tasks, such as one contact center agents for conversations and another for back-office agents.
        ...
        <img src="../case management/images/default-assignee-queue.png" alt="Queues" title="Queues" style="border: 1px solid gray; zoom:70%;">

    * **Individual Agent**: Assign to a specific agent automatically.

        <img src="../case management/images/individual-agent.png" alt="Individual Agent" title="Individual Agent" style="border: 1px solid gray; zoom:70%;">

    * **Task Creator**: Assign the task to you if you have created it.

        <img src="../case management/images/task-creator.png" alt="Task Creator" title="Task Creator" style="border: 1px solid gray; zoom:70%;">

4. Click **Next** to move to the **New Task Template - Add Fields** page.

    <img src="../case management/images/new-task-template-basic-info.png" alt="New Task Template" title="New Task Template" style="border: 1px solid gray; zoom:70%;">
...
1. Click **+ Add Fields** to add **Custom** fields to the new task template.
    ...
    <img src="../case management/images/edit-add-fields.png" alt="Custom" title="Custom" style="border: 1px solid gray; zoom:70%;">
...
2. Click **Create** to finalize the task template.
    ...
    <img src="../case management/images/add-fields-create.png" alt="Create" title="Create" style="border: 1px solid gray; zoom:70%;">

### Edit Task Templates

Steps to edit new task:

1. On the **Task Templates** page, click the vertical ellipsis (<img src="../case management/images/ellipsis-icon.png" style="zoom:50%;"></img>) button to edit the Custom task template. 

    <img src="../case management/images/edit-task-template.png" alt="Edit Task Template" title="Edit Task Template" style="border: 1px solid gray; zoom:70%;">

2. Select **Edit** to modify the basic information as required.

    <img src="../case management/images/edit-basic-info.png" alt="Edit Basic Info" title="Edit Basic Info" style="border: 1px solid gray; zoom:70%;">

3. Modify the required fields or add new fields if needed.

    <img src="../case management/images/edit-add-fields.png" alt="Modify" title="Modify" style="border: 1px solid gray; zoom:70%;">
...
1. On the **Task Templates** page, click the vertical ellipsis (<img src="../case management/images/ellipsis-icon.png" style="zoom:50%;"></img>) button to delete the Custom task template. 

<img src="../case management/images/delete-task-template.png" alt="Delete Task Template" title="Delete Task Template" style="border: 1px solid gray; zoom:70%;">

2. Click **Delete** to **confirm**.

    <img src="../case management/images/delete-confirm.png" alt="Delete" title="Delete" style="border: 1px solid gray; zoom:70%;">
...
1. Access case management **Case Templates** by navigating to **Contact Center AI** > **Case Management** > **Configuration**> **Case Templates**.
    ...
    <img src="../case management/images/case-templates.png" alt="Case Template" title="Case Template" style="border: 1px solid gray; zoom:70%;">
...
1. On the **Case Templates** page, click **+ New Case Template**. 
    ...
    <img src="../case management/images/case-templates-creation.png" alt="New Case Template" title="New Case Template" style="border: 1px solid gray; zoom:70%;">
...
2. In the **New Case** panel, complete the following sections in sequence.
    ...
    <img src="../case management/images/new-case-basic-inf.png" alt="Basic Information" title="Basic Information" style="border: 1px solid gray; zoom:70%;">
    ...
    c. Based on your preferences, choose the following **Default Assignee** options provided:
        ...
        * **Unassigned**: By default, the new case is not automatically assigned upon creation.
            ...
            <img src="./images/new-case-unassigned.png" alt="Unassigned" title="Unassigned" style="border: 1px solid gray; zoom:70%;"> 
        ...
        * **Queues**: Administrators can create queues for specific agent groups and assign them to a particular case. Customize queues or use defaults, such as creating one for contact center agents and another for back office employees.
            ...
            <img src="../case management/images/new-case-queues.png" alt="Case Creator" title="Case Creator" style="border: 1px solid gray; zoom:70%;">
        ...
        * **Individual Agent**: The cases automatically get assigned to a specific individual agent.         
            ...
            <img src="../case management/images/new-case-individual-agent.png" alt="Individual Agent" title="Individual Agent" style="border: 1px solid gray; zoom:70%;"> 

        * **Case Creator**: The cases assigned to the user who has created and initiated the task.

            <img src="../case management/images/new-case-creator.png" alt="Case Creator" title="Case Creator" style="border: 1px solid gray; zoom:70%;">

3. Click **Next** to proceed to the following **Case Fields** page.    

    <img src="../case management/images/add-case-fields.png" alt="Case Fields" title="Case Fields" style="border: 1px solid gray; zoom:70%;">
...
1. Click **+ Add Fields** to include Custom fields.
    ...
    <img src="../case management/images/add-case-fields.png" alt="Add Fields" title="Add Fields" style="border: 1px solid gray; zoom:70%;">
...
3. Click **Next** to proceed to the **Task** page.
    ...
    <img src="../case management/images/new-case-next.png" alt="New Case Task" title="New Case Task" style="border: 1px solid gray; zoom:70%;">
...
4. Click **Create**. 
   ...
   <img src="../case management/images/new-case-task.png" alt="Add Task" title="Add Task" style="border: 1px solid gray; zoom:70%;">

### Edit Case Templates

Steps to edit new case template:

1. On the **Case Templates** page, click the three vertical ellipsis (<img src="../case management/images/ellipsis-icon.png" style="zoom:50%;"></img>) button to edit the custom case templates. 

   <img src="../case management/images/edit-case-temlate.png" alt="Edit Case Template" title="Edit Case Template" style="border: 1px solid gray; zoom:70%;">

2. Click **Edit** to modify **Basic Information**, **Name**, and **Description**, and click **Next**.

   <img src="../case management/images/edit-basic-info-case.png" alt="Modify basic Info" title="Edit Case Fields" style="border: 1px solid gray; zoom:70%;">

3. Modify **Case Fields** (**Field Name**, **Type**, **Validation**, or **Action**), and click **Next**.

   <img src="../case management/images/case-fields-edit.png" alt="Edit Case Fields" title="Edit Case Fields" style="border: 1px solid gray; zoom:70%;">
...
4. Modify **Task** Fields (**Custom Task**, **Add Task,** or **+Add Task**) in the **Task Name** search list to add new fields if required, and click **Update** to save changes.
   ...
   <img src="../case management/images/edit-task-case.png" alt="Modify Task" title="Modify Task" style="border: 1px solid gray; zoom:70%;">

### Delete Case Templates

Steps to delete the case template:

1. On the **Case Templates** page, click the three vertical ellipsis (<img src="../case management/images/ellipsis-icon.png" style="zoom:50%;"></img>) button. 

   <img src="../case management/images/delete-case-confirm.png" alt="Delete Case Template" title="Delete Case Template" style="border: 1px solid gray; zoom:70%;">

2. Click **Delete** to confirm. When you delete this, the following warning popup dialog box appears.

   <img src="../case management/images/delete-case-template.png" alt="Delete" title="Delete" style="border: 1px solid gray; zoom:70%;">
...
Access case management **Status** by navigating to **Contact Center AI** > **Case Management** > **Configuration** > **Status**.
   ...
   <img src="../case management/images/new-status-access.png" alt="New Status" title="New Status" style="border: 1px solid gray; zoom:70%;">
...
1. On the **Status** page, click **+ New Status**.    
   ...
   <img src="../case management/images/new-status-access.png" alt="Status" title="Status" style="border: 1px solid gray; zoom:70%;">

2. In the **New Status** panel, do the following:

    1. Enter the **Name** for the status.

    <img src="../case management/images/new-status-fields.png" alt="New Status" title="New Status" style="border: 1px solid gray; zoom:70%;">
...
1. On the **Status** page, click the three vertical ellipsis (<img src="../case management/images/ellipsis-icon.png" style="zoom:50%;"></img>) button to edit the existing status tasks. 

    <img src="../case management/images/edit-status-edit.png" alt="Status" title="Status" style="border: 1px solid gray; zoom:70%;">

2. Click **Edit**. The following **Edit Status** dialog page appears.

    <img src="../case management/images/edit-status-fields.png" alt="Edit Status" title="Edit Status" style="border: 1px solid gray; zoom:70%;">
...
1. On the **Status** page, click the three vertical ellipsis (<img src="../case management/images/ellipsis-icon.png" style="zoom:50%;"></img>) button to delete the existing status fields. 

    <img src="../case management/images/edit-status-delete.png" alt="Delete" title="Delete" style="border: 1px solid gray; zoom:70%;">

2. Click **Delete** to confirm.

    <img src="../case management/images/delete-status.png" alt="Delete Status" title="Delete Status" style="border: 1px solid gray; zoom:70%;">
...
<img src="../case management/images/new-priority- access.png" alt="Priority" title="Priority" style="border: 1px solid gray; zoom:70%;">
...
2. In the **New Priority** page, do the following:
    ...
    <img src="../case management/images/new-priority-enabled.png" alt="New Priority" title="New Priority" style="border: 1px solid gray; zoom:70%;">
...
1. On the **Priority** page, click the three vertical ellipsis (<img src="../case management/images/ellipsis-icon.png" style="zoom:50%;"></img>) button to edit the existing priority tasks. 

    <img src="../case management/images/new-priority-enabled.png" alt="New Priority" title="New Priority" style="border: 1px solid gray; zoom:70%;">

2. Click **Edit**. 
    
    <img src="../case management/images/edit-priority.png" alt="Edit Priority" title="Edit Priority" style="border: 1px solid gray; zoom:70%;">
...
1. On the **Priority** page, click the vertical ellipsis (<img src="../case management/images/ellipsis-icon.png" style="zoom:50%;"></img>) button to delete the existing status fields.     

    <img src="../case management/images/delete-priority.png" alt="Edit Priority" title="Edit Priority" style="border: 1px solid gray; zoom:70%;">

2. Click **Delete** to remove the custom priority cases.

    <img src="../case management/images/delete-custom-priority.png" alt="Delete Priority" title="Delete Priority" style="border: 1px solid gray; zoom:70%;">