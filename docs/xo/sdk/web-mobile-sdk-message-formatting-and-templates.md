...
* **Link** – [Text for the link here](https://myCompany.com) For example, `Here is a link to [Kore.ai.com](https://kore.ai/).`
* **New Line** – \n One line indention.
* **Multi Line** – \n\n\n Three line indentions.
* **Image** – ![Text for the link here](https://myCompany.com) For example, `![My image](https://d1hqmx8kqvpnpa.cloudfront.net/f-eeca5df3-7580-5a09-9aa3-09f809b44ac4.png)`
* **List** –
