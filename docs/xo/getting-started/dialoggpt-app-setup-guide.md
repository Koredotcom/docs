...
2. **Batch Testing**: Evaluate and validate AI agent accuracy and reliability across conversation types at scale. The framework supports test suite creation through CSV or JSON uploads or manual creation and provides comprehensive performance metrics. Refer to [DialogGPT - Batch Testing](../automation/testing/batch-testing-dialoggpt.md).
...
1. **Evaluate Performance**: The platform provides various dashboards to analyze real-time data generated by AI Agents during their interactions. Refer to [Analyze Your AI Agents](../analytics/introduction.md).