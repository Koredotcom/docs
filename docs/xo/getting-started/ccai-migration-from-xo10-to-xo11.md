...
| Performance Management Settings        | Moved to Contact Center AI > Performance Management > Settings. [Learn more](../quality-management/configure/settings/quality-ai-general-settings/) |
