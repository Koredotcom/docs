...
| Performance Management Settings        | Moved to Contact Center AI > Performance Management > Settings. [Learn more](../quality-ai/configure/quality-ai-general-settings.md) |
