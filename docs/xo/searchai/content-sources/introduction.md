...
* [**Websites**](web-crawl.md): Extract and index content from websites. 
* [**Documents**](directory.md): Index data from files in various formats like PDF, docx, ppt, etc.
* [**Connectors**](connectors.md): Extract data from third-party applications like ServiceNow, Confluence, etc.

In the **Content** section of Search AI, you can easily manage your data sources. Here, you can add or update any content source, with different content sources listed under different pages for easy navigation.
