...
* **Cross Encoder Re-Ranker** - Uses the _cross-encoder/ms-marco-MiniLM-L-6-v2_ model. It's lightweight, fast, and most suitable for English Language.
* **BGE Re-Ranker** - Uses _BAAI/bge-reranker-v2-m3_ model. It's a lightweight re-ranking model and possesses multilingual capabilities. 
