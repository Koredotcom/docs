...
!!! note
The feedback mechanism mentioned here is different from the feedback surveys that can be created in XO. It is specifically designed to capture user responses related to answer relevance and accuracy within the Search AI experience.
