...
* **Upgraded Web Crawler** for improved performance and better handling of complex sites.
* **Optimized JavaScript Crawling & Memory Management **with reduced resource usage.
* **The Default tag exclusion for HTML pages **automatically excludes non-essential HTML tags during processing, resulting in cleaner, more relevant content and improved indexing accuracy. 
...
Search AI is now seamlessly integrated into the XO platform as part of the broader **AI for Service** suite. This integration brings together enterprise-grade search, automation, and assistance within a unified ecosystem. By combining Search AI's generative intelligence and deep retrieval capabilities with XO’s automation, contact center, and agent-assist features, enterprises can deliver highly contextual conversational experiences across channels. With support for a wide range of LLMs, **including third-party models such as OpenAI and Azure OpenAI,** **as well as custom or fine-tuned enterprise models**, organizations gain the flexibility to align AI performance with their specific needs. To further streamline deployment, a built-in **model and prompt library** accelerates implementation across a wide variety of use cases.
