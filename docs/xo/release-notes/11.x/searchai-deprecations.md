...
**Automatic Migration Date: December 06, 2025**
...
After December 6, 2025, the existing applications will automatically switch to BGE V2 and VDR.
...
*Note: The new crawler was released on May 31, 2025. New applications automatically use it, while existing applications can upgrade early via banner notification or will be automatically migrated by December 6, 2025.*
...
The existing applications will be automatically migrated in batches by December 6, 2025. Upon completion of the migration, you will receive a pop-up notification confirming the upgrade.
...
<table>
  ...
  <tr>
   <td><strong>December 6, 2025</strong>
   </td>
   <td>Automatic migration of all existing applications.
   </td>
  </tr>
  <tr>
   <td><strong>After December 6, 2025</strong>
   </td>
...
No, after December 6, 2025, only the new crawler will be available. However, the new crawler provides significant performance and reliability improvements.
