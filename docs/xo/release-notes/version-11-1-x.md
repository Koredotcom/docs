...
=== "Automation AI"
    ...
    * Digital Forms Date Picker Supports Japanese:
    The digital form’s Date Picker now supports the Japanese language if the bot language is Japanese.
...
## v11.0.0 April 10, 2024

**Major Release**

To learn about the new features and enhancements included in XO 11 of Kore.ai Experience Optimization Platform. See [What's New in XO 11](../getting-started/whats-new-in-xo-platform.md).