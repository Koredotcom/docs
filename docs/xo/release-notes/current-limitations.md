...
* The App language (display language) is available only in English, Japanese (Beta), Korean (Beta), and German (Beta).
<hr>

##### Related Links

* [What's New in AI for Service (XO) v11](../getting-started/whats-new-in-xo-platform.md)
* [Key Differences - v11 vs. v10](../getting-started/key-differences-between-xo11-and-xo10.md)
