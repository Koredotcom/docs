...
Also, patterns can also be used in [Small Talk](../../../automation/use-cases/small-talk/#terminology){:target="_blank"} (while defining queries), [Knowledge Graph](../../../automation/use-cases/knowledge-ai/build-a-knowledge-graph/#add-faqs){:target="blank"} (using alternate question field), and [Trait](../../../automation/natural-language/training/traits/#trait-definition){:target="_blank"} identification but their behavior might differ slightly.
