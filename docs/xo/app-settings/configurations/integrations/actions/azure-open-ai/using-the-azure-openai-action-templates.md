...
1. Refer to the [Installing the Azure OpenAI Action Templates](https://docsinternal-kore.github.io/docs/xo/app-settings/configurations/integrations/actions/asana/configuring-the-azure-openai-action/#step-3-install-the-azure-openai-action-templates){:target="_blank"} section to install this template.
