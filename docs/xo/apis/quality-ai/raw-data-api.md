...
The Raw Data API provides interaction-level data for Quality AI and Conversation Intelligence, including evaluation metrics, sentiment, emotions, and analytics attributes. It includes the duration_status field per contact, supports threshold-based filtering, and includes Generated Intents and Configured Intents (L1–L3 hierarchy with confidence, sentiment, and resolution).
