...
| [User Engagement Trend (v2)](./user-engagement-trend-v2.md) | To retrieve analytics data that shows how many users have interacted with a specific app in a workspace, including unique, new, and returning users, along with average counts over a specified period and configurable time intervals (daily or hourly). | User Engagement Trend | NA  |
