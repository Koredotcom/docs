# Case Management - API Rate Limits 
...
|------------------------|-------------------|------|
| account               | 60 per minute    | [Create Case](../case-management-apis/create-a-case.md) <br> [Get Cases](../case-management-apis/get-cases.md) <br> [Update Case](../case-management-apis/update-a-case.md) <br> [Create Task](../case-management-apis/create-a-task.md) <br> [Get Tasks](../case-management-apis/get-tasks.md) <br> [Update Task](../case-management-apis/update-a-task.md) |
