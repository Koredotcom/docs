...
<table>
  ...
  <tr>
   ...
   <td>Specify the number from which to start fetching the AI Agents created in the account. If unspecified, it starts from 0, which is the first page of the list of bots.
   </td>
  </tr>
  <tr>
   <td>limit
   ...
   <td>The number of AI Agents to fetch. The maximum applicable limit is 50.
   </td>
  </tr>
</table>
