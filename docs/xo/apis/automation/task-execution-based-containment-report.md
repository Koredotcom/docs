...
The <b>_id</b> generated by the POST method, (for example,  *ds-9xxxxxxd-0xx4-5xx8-axx8-axxxxxxxd083* shown in the sample POST response) should be used as the query parameter in the below GET Method.
