...
| API                                                                                               | DESCRIPTION                                                                                                  | ASSOCIATED APP SCOPE |
|---------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|----------------------|
| [Raw Data API](../contact-center/qm-apis/raw-data-api)                                                               | To create a queue with the given streamId.                                                                   | Configuration        |
| [Auto QA Reporting API](../contact-center/qm-apis/auto-qa-reporting-api.md)                                                   | To get a list of queues with the given streamId.                                                             | Configuration        |
