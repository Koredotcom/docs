...
| [Get All Conversations Data – Call Details-v1](../contact-center/get-all-conversations-data-call-details-v1.md) | To retrieve the raw data for all conversations with the given Account Id.                                              | SmartAssist Analytics |
