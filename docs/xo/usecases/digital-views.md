...
![create widget](../usecases/images/create-widget.png "create widget")

2. The New Widget dialog opens.
![new widget dialog](../usecases/images/new-widget-dialog.png "new widget dialog")
...
> **Note**: A Digital Form can be used to define multiple Widgets and can also be added to multiple Panels. However, it will be associated with the same Dialog Task across all Widgets and Panels.
