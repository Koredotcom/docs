...
![switch knowledge graph](../usecases/images/switch-knowledge-graph.gif "switch knowledge graph")

Changing Knowledge Graph Types is captured in the Change Logs, which you can access by going to **Deploy > Change Logs**.

> **Note**: Before changing your Knowledge Graph Type, we recommend backing up your existing knowledge graph by either creating a new bot version or by exporting a copy of your knowledge graph as a JSON or CSV.
