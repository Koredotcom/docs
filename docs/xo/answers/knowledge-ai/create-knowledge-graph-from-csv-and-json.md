...
6. On the corresponding dialog box, click **Sample CSV**. The CSV file is downloaded to your local computer.
    ...
    <img src="../../automation/use-cases/images/download-sample-csv.png" alt="download sample csv" title="download sample csv" style="border: 1px solid gray; zoom:75%;">
...
<img src="../../automation/use-cases/images/faq-sample.png" alt="FAQ Sample" title="FAQ Sample" style="border: 1px solid gray; zoom:75%;">
...
<img src="../../automation/use-cases/images/nodes-and-tags-settings.png" alt="Nodes and Tags Settings" title="Nodes and Tags Settings" style="border: 1px solid gray; zoom:75%;">
...
<img src="../../automation/use-cases/images/enter-synonyms.png" alt="enter synonyms" title="enter synonyms" style="border: 1px solid gray; zoom:75%;">
...
<img src="../../automation/use-cases/images/kg-params.png" alt="kg params" title="kg params" style="border: 1px solid gray; zoom:75%;">

### **Traits**

Trait related information can be specified as follows:

<img src="../../automation/use-cases/images/trait-related-information.png" alt="trait related information" title="trait related information" style="border: 1px solid gray; zoom:75%;">
...
<img src="../../automation/use-cases/images/json-reference-code.png" alt="json reference" title="json reference" style="border: 1px solid gray; zoom:75%;">
