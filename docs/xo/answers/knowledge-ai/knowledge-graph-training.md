...
<img src="../../automation/use-cases/images/term-type-settings.png" alt="term type setting" title="term type setting" style="border: 1px solid gray; zoom:75%;">
...
<img src="../../automation/use-cases/images/term-types.png" alt="term types" title="term types" style="border: 1px solid gray; zoom:75%;">
...
<img src="../../automation/use-cases/images/term-field-custom-tag.png" alt="term field custom tag" title="term field custom tag" style="border: 1px solid gray; zoom:75%;">
...
3. To add **synonyms**, do the following:
    * To add local synonyms, type them in the box under **Path Level Synonyms**.
    <img src="../../automation/use-cases/images/path-level-synonyms.png" alt="path level synonyms" title="path level synonyms" style="border: 1px solid gray; zoom:75%;">
    * To add Global synonyms, click **Edit** then **Add** under **Knowledge Graph Synonyms** and enter them.
    ...
    <img src="../../automation/use-cases/images/add-global-synonyms.png" alt="add global synonyms" title="add global synonyms" style="border: 1px solid gray; zoom:75%;"></li>
   ...
   <img src="../../automation/use-cases/images/manage-synonyms.png" alt="manage synonyms" title="manage synonyms" style="border: 1px solid gray; zoom:75%;"></li></ul>
...
<img src="../../automation/use-cases/images/child-synonyms-terms.png" alt="child synonyms terms" title="child synonyms terms" style="border: 1px solid gray; zoom:75%;"></li></ol>
...
<img src="../../automation/use-cases/images/manage-traits.png" alt="manage traits" title="manage traits" style="border: 1px solid gray; zoom:75%;"></li>
...
<img src="../../automation/use-cases/images/add-traits-save-and-add-rules.png" alt="save and add rule" title="save and add rule" style="border: 1px solid gray; zoom:75%;"></li></ol>
...
<img src="../../automation/use-cases/images/manage-stop-words.png" alt="manage stop words" title="manage stop words" style="border: 1px solid gray; zoom:75%;">
...
<img src="../../automation/use-cases/images/thresholds-configurations.png" alt="thresholds and configurations" title="thresholds and configurations" style="border: 1px solid gray; zoom:75%;">
...
<img src="../../automation/use-cases/images/search-in-answer.png" alt="search in answer" title="search in answer" style="border: 1px solid gray; zoom:75%;">
