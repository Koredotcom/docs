...
<img src="../../automation/use-cases/images/import-knowledge-graph.png" alt="Import Knowledge Graph" title="Import Knowledge Graph" style="border: 1px solid gray; zoom:75%;">
...
5. In the **Import** dialog, do one of the following based on the scenario:
    ...
    * For an existing Knowledge Graph, take a backup CSV or JSON file, and then click **Proceed**.
    <img src="../../automation/use-cases/images/backup-knowledge-graph.png" alt="backup knowledge graph" title="backup knowledge graph" style="border: 1px solid gray; zoom:75%;">

6. Drag and drop the file to the **Import** window or click **Browse** to locate the file.
7. Click **Next** to begin the import.
<img src="../../automation/use-cases/images/click-begin-import.png" alt="click begin import" title="click begin import" style="border: 1px solid gray; zoom:75%;">
...
2. You can find the **Export** option on the respective Knowledge Graph.
    ...
    <img src="../../automation/use-cases/images/export-knowledge-graph.png" alt="export knowledge graph" title="export knowledge graph" style="border: 1px solid gray; zoom:75%;">
...
3. Based on the preferred format: click **Export JSON** or **Export CSV**.
    ...
    <img src="../../automation/use-cases/images/export-caching-notice-message.png" alt="export caching message" title="export caching message" style="border: 1px solid gray; zoom:75%;">
