...
![skills-live-board](../routing/images/skills/skills-page.png)
...
![new-skill-button](../routing/images/skills/new-skill-button.png)
...
3. Enter the following details in the **Add New Skill** window:
    ...
    ![add_new_skill](../routing/images/skills/add-new-skill.png)
    ...
    ![skill_created](../routing/images/skills/skill-created.png)
...
![edit-skill-button](../routing/images/skills/edit-skill-button.png)
...
3. Ensure that there are no agents assigned to the skill. If there are, you must remove them to delete the skill. Removing an agent from a skill also removes the skill assignment on the agent’s profile. Follow these steps:
    ...
    ![delete-skill-button](../routing/images/skills/delete-skill-button.png)
