...
<img src="../images/sla-page.png" alt="SLAs & Alerts Tab" title="SLAs & Alerts Tab" style="border: 1px solid gray; zoom:80%;">

The following information is displayed:  
<img src="../images/information.png" alt="Information" title="Information" style="border: 1px solid gray; zoom:80%;">
...
1. Click the **+ New Service Level** button at the upper-right corner.  
    <img src="../images/new-service-level.png" alt="New Service Level" title="New Service Level" style="border: 1px solid gray; zoom:80%;">
...
2. On the New Service Level Rule pop-up window, enter a **Name** and **Description** for the service rule and click **Next**.  
    ...
    <img src="../images/service-level-configuration-page.png" alt="Configuration" title="Configuration" style="border: 1px solid gray; zoom:80%;">
...
4. Click **+ Add triggers** and choose a trigger.  
    ...
    **Response Service Level (RSL)**:  
    <img src="../images/response-service-level.png" alt="Response Service Level" title="Response Service Level" style="border: 1px solid gray; zoom:80%;">
...
6. Click **Save** to create the service level.  
    <img src="../images/save-service-level.png" alt="Save Service Level" title="Save Service Level" style="border: 1px solid gray; zoom:80%;">
...
1. Click the **Edit** button.  
    <img src="../images/edit-sla.png" alt="Edit Service Level" title="Edit Service Level" style="border: 1px solid gray; zoom:80%;">

2. Make the necessary changes to the service level and click **Save**.  
    <img src="../images/edit-and-save.png" alt="Edit and Save Service Level" title="Edit and Save Service Level" style="border: 1px solid gray; zoom:80%;">
...
2. Click the **Settings** icon.  
    <img src="../images/settings-icon.png" alt="Settings" title="Settings" style="border: 1px solid gray; zoom:80%;">
...
4. Click **Save**.  
    <img src="../images/revised-service-level-name.png" alt="Revised Service Level Name" title="Revised Service Level Name" style="border: 1px solid gray; zoom:80%;">
...
1. Click the **Delete** button.  
    <img src="../images/delete-sla.png" alt="Delete" title="Delete" style="border: 1px solid gray; zoom:80%;">
...
1. Click **+ New Alert** at the top right corner.  
    <img src="../images/new-alert.png" alt="New Alert" title="New Alert" style="border: 1px solid gray; zoom:80%;">
...
2. Enter a **Name** and **Description** in the pop-up window and click **Next**.  
    ...
    <img src="../images/general-alert-config.png" alt="Alert Config" title="Alert Config" style="border: 1px solid gray; zoom:80%;">

3. Click and select the Area of the system.  
    <img src="../images/system-area.png" alt="System Area" title="System Area" style="border: 1px solid gray; zoom:80%;">

4. Click and select the trigger.  
    <img src="../images/triggers.png" alt="Triggers" title="Triggers" style="border: 1px solid gray; zoom:80%;">

5. Select the number of times the system exports data within the selected time interval.  
    <img src="../images/time-interval-times.png" alt="Interval Times" title="Interval Times" style="border: 1px solid gray; zoom:80%;">

6. Click and add Actions. You can add both Alert and Email.  
    <img src="../images/add-action.png" alt="Actions" title="Actions" style="border: 1px solid gray; zoom:80%;">

7. Select the Alert type (Critical/Warning) and select the people to whom the alert will be sent.  
    <img src="../images/alert-type-people.png" alt="Alert Type" title="Alert Type" style="border: 1px solid gray; zoom:80%;">

8. Click **Save**.  
    <img src="../images/save-alert.png" alt="Save Alert" title="Save Alert" style="border: 1px solid gray; zoom:80%;">
...
1. Click the **Edit** button.  
    <img src="../images/edit-alert-icon.png" alt="Edit Alert" title="Edit Alert" style="border: 1px solid gray; zoom:80%;">

2. Make the necessary changes to the general alert and click **Save**.  
    <img src="../images/edit-alert.png" alt="Edit and Save Alert" title="Edit and Save Alert" style="border: 1px solid gray; zoom:80%;">
...
2. Click the **Settings** icon.  
    <img src="../images/alert-settings.png" alt="Alert Settings" title="Alert Settings" style="border: 1px solid gray; zoom:80%;">
...
4. Click **Save**. The revised alert name is displayed.  
    <img src="../images/alert-name-updated.png" alt="Alert Updated" title="Alert Updated" style="border: 1px solid gray; zoom:80%;">
...
1. Click the **Delete** button.  
    <img src="../images/delete-alert.png" alt="Delete Alert" title="Delete Alert" style="border: 1px solid gray; zoom:80%;">

2. Click **Delete**.  
<img src="../images/confirm-delete-alert.png" alt="Confirm Delete Alert" title="Confirm Delete Alert" style="border: 1px solid gray; zoom:80%;">
