...
The Logs page includes date-based filters to refine results. A calendar control is available to select the specific date range for which logs will be displayed.

### Search

The Search function supports queries on the Description field.
Users can enter any part of a campaign name, user name, or reason to find matching log entries.

### Export Logs

Users can export campaign logs to a CSV file.
The exported file includes all visible columns and reflects the applied filters and search criteria.
