# Replace Customer Column Data With User ID

The “Customer” column in the Interactions Dashboard displays the User ID instead of the customer’s email address or phone number when enabled. This change only applies to customers who activate the setting; others will see no change in the dashboard display. This enhancement supports organizations that prefer anonymized identifiers for improved privacy or system alignment.
