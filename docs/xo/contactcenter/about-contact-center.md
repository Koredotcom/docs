...
<kr-grid type="g2">
    <kr-grid-item>
        ...
        [Learn more about Flows :octicons-arrow-right-24:](../flows/introduction-to-flows.md)
    </kr-grid-item>
    <kr-grid-item>
        ...
        [Learn more about Routing :octicons-arrow-right-24:](./routing/queues/queue-management.md)
    </kr-grid-item>
    <kr-grid-item>
        ...
        [Learn more about Agents and Supervisors :octicons-arrow-right-24:](./agent-and-supervisors/agent-management/agent-management.md)
    </kr-grid-item>           
    <kr-grid-item>
        ...
        [Learn more about Configurations :octicons-arrow-right-24:](./configurations/agentassist-settings/agentassist-settings.md)
    </kr-grid-item>
    <kr-grid-item>
        ...
        [Learn more about Agent Console :octicons-arrow-right-24:](../console/conversation-tray/conversation-tray.md)
    </kr-grid-item>
     <kr-grid-item>
        ...
        [Learn more about Campaigns :octicons-arrow-right-24:](./campaigns/about-campaigns.md)
    </kr-grid-item>            
</kr-grid>