...
| **On Customer Interruption after Agent Transfer**         | If customer gets disconnected unexpectedly, conversations will wait with agent for                                                    | Live Chat, Messaging.   | ToAgent     | Agent Full Name, Agent First Name, Agent Last Name, Agent Nick Name.                  |
