...
!!! Note
    ...
    _The role of Bot Owner is assigned at the time of Bot creation and can be changed either from the Bots Management module or from the Platform by the Bot Owner not from Role Management.
