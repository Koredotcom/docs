...
This configures a metric based on adherence to a playbook or a specific playbook step.
...
4. Select an **Adherence Type **from the dropdown. **Adherence Percentage **and **Steps **are the two options available under this.
    * **Entire Playbook**: Select a playbook** **from the dropdown** **that you want to evaluate adherence across the entire playbook. 
...
![alt_text](images/image3.png "image_tooltip")
        ...
        * Select** Steps** if you want to evaluate adherence to specific steps of the playbook. If you select Steps, then define the following two options.
...
2. Enter a descriptive **Name** for the future audit reference.
3. Select a **Playbook Name **from the dropdown list, from which the metric should evaluate adherence.
4. Select an **Adherence Type **from the dropdown. There are two options available under this.
    * **Entire Playbook**: Select a playbook** **from the dropdown** **that you want to evaluate adherence across the entire playbook. 
        * Select** Steps** if you want to evaluate adherence to specific steps of the playbook. If you select Steps, then define the following two options.
            * **Stage:** Select the stage under which the desired step for evaluation is configured.
            * **Step**: Select the desired step for adherence evaluation.
