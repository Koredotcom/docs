...
<img src="../settings/quality-ai-general-settings/images/sett-agent-scorecard.png" alt="Auto QA" title="Auto QA" style="border: 1px solid gray; zoom:60%;">
...
<img src="../settings/quality-ai-general-settings/images/settings-new-bookmarks.png" alt="New Bookmarks" title="New Bookmarks" style="border: 1px solid gray; zoom:100%;">
