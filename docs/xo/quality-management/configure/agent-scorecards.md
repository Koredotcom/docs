...
5. Enable the **Mark as Default** toggle option to assign the default scorecards across all agents. By default, the toggle option is enabled for the first scorecard created.  
...
6. The pass score must be configured (40 by default).
