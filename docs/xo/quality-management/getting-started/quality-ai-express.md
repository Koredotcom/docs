...
## Important: What You Should Know First
...
<table>
  <tr>
   ...
   <td><strong>Quality AI Express (3rd-Party)</strong>
   </td>
...
***Partial Agent Performance KPIs exclude**: CSAT integration, agent occupancy monitoring, agent state distribution, and playbook adherence tracking.
...
For detailed technical specifications and implementation guidance, see the[ AWS S3 Connector Setup Guide](https://docs.google.com/document/d/1ds7LGf3Pj91hVUMmayax83P6mn6EjDxtp7_Ny69-5F8/edit?usp=sharing).
...
For detailed setup, see the[ AWS S3 Connector Setup Guide.](https://docs.google.com/document/d/1ds7LGf3Pj91hVUMmayax83P6mn6EjDxtp7_Ny69-5F8/edit?usp=sharing)

## Migration Path

Organizations using Quality AI Express can seamlessly migrate to the full Quality AI platform if they adopt CCAI Contact Center AI (CCAI) in the future. This migration path provides:
