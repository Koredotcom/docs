...
4. Create Evaluation Metrics:
    ...
    1. Use By Question, Question Answer Pair, and Adherence Types (Static/Dynamic). See [Evaluation Metrics](../configure/evaluation-metrics.md).

    b. 	Set Count Type (Entire Conversation/Time Bound). See[ Add New Evaluation Metrics](../configure/evaluation-metrics.md#add-new-evaluation-metrics).  
...
6. View scored interactions in Conversation Mining:
    ...
    2. Save filters for audit assignments. See [Conversation Mining](../analyze/conversation-mining-interactions.md/).

7. Create Audit Allocations

    2. Assign interactions to auditors for manual evaluation. See [Add New Audit Allocation](../analyze/conversation-mining-audit-allocations.md#add-new-audit-allocation).

8. Expedite Manual audits:

    1. Use AI-assisted audits for easier scoring.

    2. Navigate interactions using adherence moments and violations. See [AI-Assisted Manual Audit](../getting-started/ai-assisted-manual-audit.md).
...
9. Monitor performance:
    ...
    See [Dashboard](../analyze/dashboard.md).