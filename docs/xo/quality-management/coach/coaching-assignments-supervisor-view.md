...
<img src="../coach/coaching-assignments/images/dashboard-overview.png" alt="Add Coaching Assignments" title="Add Coaching Assignments" style="border: 1px solid gray; zoom:100%;">  
...
<img src="../coach/coaching-assignments/images/add-coaching-evaluation-assignment.png" alt="Agent Leaderboard" title="Agent Leaderboard" style="border: 1px solid gray; zoom:100%;">
...
3. Right-click on the vertical ellipsis (⋮) button and click **View**.  
    ...
    <img src="../coach/coaching-assignments/images/chat-audit-history-details.png" alt="View Agent Interactions" title="View Agent Interactions" style="border: 1px solid gray; zoom:60%;">

3. Click the **Add Coaching Assignment**, the following screen appears.    
    <img src="../coach/coaching-assignments/images/add-new-coaching-assignment1.png" alt="Add Coaching Assignment" title="Add Coaching Assignment" style="border: 1px solid gray; zoom:60%;">

4. Enter the **Name** of the coaching assignment.    
    <img src="../coach/coaching-assignments/images/add-coaching-assignments-name.png" alt="Add Coaching Assignment" title="Add Coaching Assignment" style="border: 1px solid gray; zoom:60%;"> 

5. In the **Coaching Area**, enter the agent attributes that are selected for coaching as part of the assignment.  
    <img src="../coach/coaching-assignments/images/add-coaching-assignments-coaching-area.png" alt="Add Coaching Assignment" title="Add Coaching Assignment" style="border: 1px solid gray; zoom:60%;"> 

5. By default, the Interactions Marked for Coaching details, which are selected from the evaluation tab, are displayed.  
    <img src="../coach/coaching-assignments/images/interactions-marked-for-coaching.png" alt="Add Coaching Assignment" title="Add Coaching Assignment" style="border: 1px solid gray; zoom:60%;"> 
...
<img src="../coach/coaching-assignments/images/best-responses.png" alt="Add Coaching Assignment" title="Add Coaching Assignment" style="border: 1px solid gray; zoom:60%;"> 
