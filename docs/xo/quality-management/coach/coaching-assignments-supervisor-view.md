...
4. Click the **Add Coaching Assignment**, the following screen appears.    
...
5. Enter the **Name** of the coaching assignment.
...
6. In the **Coaching Area**, enter the agent attributes that are selected for coaching as part of the assignment.  
...
7. By default, the Interactions Marked for Coaching details, which are selected from the evaluation tab, are displayed.  
...
8. Under the **Best Responses** (optional), select the best response interactions from other agents to provide best reference for this coaching assignment using saved bookmarks. You can select more than one bookmark based on the evaluation criteria, for example, one set of interactions for the support queue and another set of interactions for the best responses to get populated in the selected interactions box.    
...
9. In the **Feedback**, enter your feedback for better improvement.
10. Enter **the Action Plan** for the coaching assignment.
11. Provide the input for the **Follow-up Date** chosen for the assignment
12. Click **Create** to assign coaching assignments to an agent, which will be populated in the **Agent Dashboard**.
