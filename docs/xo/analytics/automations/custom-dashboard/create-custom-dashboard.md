...
<img src="../images/filter-the-mesage-using-having-clause 1.png" alt="Filter the Mesage Using Having Clause 1" title="Filter the Mesage Using Having Clause 1" style="border: 1px solid gray; zoom:80%;">
