...
**Note**: This formula is applicable when a call doesn't return to the same queue multiple times. If it does, it will be counted multiple times and doesn't add up correctly.
