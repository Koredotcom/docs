...
Upon selecting any of the assigned coaching assignments from the widget, the best response interactions pane of the New Coaching Assignment screen gets displayed.  
...
* **Interactions Marked for Coaching**: This shows the following interaction details marked for coaching.
  ...
  * **Action**: This refers to a call-to-action (CTA) that allows you to access the corresponding agent's audit interaction screen.  
  <img src="../coaching-assignments/images/interaction-audit-status-coaching-assignment.png" alt="Interaction Audit Status" title="Interaction Audit Status" style="border: 1px solid gray; zoom:60%;">
