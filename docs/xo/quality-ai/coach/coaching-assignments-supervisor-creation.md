# Coaching Assignments - Supervisor Creation
...
1. Click any of the agents from the Agent Leaderboard widget, which navigates you to the **Quality AI** > **Dashboard** > **Agent Leaderboard** > **Overview** to navigate to the agent-specific dashboard.  
