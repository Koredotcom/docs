# Agent Dashboard - Supervisor Evaluation
...
<img src="../agent-leaderboard/images/agent-dashboard-sup-eva-filter.png" alt="Agent Dashboard-Sup View Filter" title="Agent Dashboard-Sup View Filter" style="border: 1px solid gray; zoom:60%;">
...
<img src="../agent-leaderboard/images/agent-dashboard-sup-eva-add-coaching.png" alt="Add Coaching Assignments" title="Add Coaching Assignments" style="border: 1px solid gray; zoom:60%;">

3. Enter the **Name** of the coaching assignment.  
<img src="../agent-leaderboard/images/agent-dashboard-new-coaching-assignment.png" alt="Coaching Assignments Name" title="Coaching Assignments Name" style="border: 1px solid gray; zoom:60%;">
...
<img src="../agent-leaderboard/images/agent-dashboard-sup-eva-coaching-area.png" alt="Agent Dashboard-Sup View" title="Agent Dashboard-Sup View" style="border: 1px solid gray; zoom:60%;">
...
<img src="../agent-leaderboard/images/agent-dashboard-sup-eva-interactions-marked.png" alt="Agent Dashboard-Sup View" title="Agent Dashboard-Sup View" style="border: 1px solid gray; zoom:60%;">
...
<img src="../agent-leaderboard/images/agent-dashboard-sup-eva.png" alt="Agent Dashboard-Sup View" title="Agent Dashboard-Sup View" style="border: 1px solid gray; zoom:60%;">
    ...
    By clicking the **View Interactions** button, the supervisors can get more insights related to coaching of the agents, implement training programs, and make informed decisions. 
<img src="../agent-leaderboard/images/agent-dashboard-sup-eva.png" alt="Agent Dashboard-Sup View" title="Agent Dashboard-Sup View" style="border: 1px solid gray; zoom:60%;">


    By clicking the **Add Interactions** button, the supervisors can choose the best interactions from other agents to provide as reference for this coaching assignment using saved bookmarks.   
<img src="../agent-leaderboard/images/agent-dashboard-sup-eva.png" alt="Agent Dashboard-Sup View" title="Agent Dashboard-Sup View" style="border: 1px solid gray; zoom:60%;">

    In this, you can choose the required agent interactions by clicking the **Add Interaction** button to move the agent coaching references to the **Selected Interactions** box.  
<img src="../agent-leaderboard/images/agent-dashboard-sup-eva.png" alt="Agent Dashboard-Sup View" title="Agent Dashboard-Sup View" style="border: 1px solid gray; zoom:60%;">

7. In the **Feedback**, enter your feedback for better improvement or suggestions.  
<img src="../agent-leaderboard/images/agent-dashboard-sup-eva.png" alt="Agent Dashboard-Sup View" title="Agent Dashboard-Sup View" style="border: 1px solid gray; zoom:60%;"> 
...
10. Click **Create** to assign coaching assignments to an agent, which gets populated in the **Agent Dashboard**.