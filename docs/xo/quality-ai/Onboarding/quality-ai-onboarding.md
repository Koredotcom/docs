...
1. Access to the **AI for Service** [Homepage](https://platform.kore.ai/builder/).
...
<img src="../images/xo-landing-page.png/" alt="XO Landing Page" title="XO Landing Page" style="border: 1px solid gray; zoom:80%;">

4. Select the **New App** dropdown located at the upper right corner of the XO landing page.

5. Click **+ New App**.   
<img src="../images/navigate-to new-app.png/" alt="New App" title="New App" style="border: 1px solid gray; zoom:80%;">

6. Select **Quality AI**.   
<img src="../images/Quality-ai-new-user.png/" alt="Try Now" title="Try Now" style="border: 1px solid gray; zoom:80%;">
...
<img src="../images/choose-langs.png/" alt="Preferred Language" title="Preferred Language" style="border: 1px solid gray; zoom:80%;">
...
<img src="../images/add-new-lang.png/" alt="Select Language" title="Select Language" style="border: 1px solid gray; zoom:80%;">

4. Toggle on any language in the list to **Mark as the Default**.   
<img src="../images/set-default-lang.png/" alt="Mark Default Language" title="Mark Default Language" style="border: 1px solid gray; zoom:80%;">
...
<img src="../images/de-selection-lang.png/" alt="Deselect Language" title="Mark Deselect Language" style="border: 1px solid gray; zoom:80%;">
...
<img src="../images/conversation-sources-basic-settings-configuration.png/" alt="Queue Configuration" title="Queue Configuration" style="border: 1px solid gray; zoom:80%;">
...
* Enable auditing (manual review) for:
    ...
    * Audit Agent AI Playbook metrics   
    <img src="../images/app-usage-settings.png/" alt="App Usage Setting" title="App Usage Setting" style="border: 1px solid gray; zoom:80%;"> 
...
<img src="../images/product-switcher.png/" alt="Product Switcher" title="Product Switcher" style="border: 1px solid gray; zoom:80%;"> 
...
<img src="..//images/conversation-sources.png/" alt="Conversation Sources" title="Conversation Sources" style="border: 1px solid gray; zoom:80%;"> 
...
<img src="..//images/conversation-sources-left-navigation.png/" alt="App Usage Setting" title="App Usage Setting" style="border: 1px solid gray; zoom:80%;"> 
