...
<img src="../reports/reports.png" alt="Reports" title="Reports" style="border: 1px solid gray; zoom:80%;">
...
* **Ellipsis (Vertical) Icon/Button**: Click to open a menu with additional actions, such as duplicate, share, delete, export, or view history.  
<img src="../reports/reports.png" alt="Reports" title="Reports" style="border: 1px solid gray; zoom:80%;">
...
<img src="../reports/reports.png" alt="Reports" title="Reports" style="border: 1px solid gray; zoom:80%;">
    ...
    * **Search Bar**: Find reports by name, type, or creator.
