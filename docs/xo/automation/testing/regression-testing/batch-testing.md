...
<img src="../images/batch-testing-5-add-testcase-manually.png" alt="BT - Add Test Case Manually" title="BT - Add Test Case Manually" style="border: 1px solid gray; zoom:50%;"/>
