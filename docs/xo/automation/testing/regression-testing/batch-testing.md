...
<img src="/docs/xo/automation/testing/images/batch-testing-5-add-manually.png" alt="Add test case manually" title="Add test case manually" style="border: 1px solid gray; zoom:50%;"/>
