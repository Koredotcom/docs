...
<kr-grid type="g2">
    <kr-grid-item>
        ...
        <a href="../use-cases/dialogs/dialog-tasks-overview.md">Learn More</a>
    </kr-grid-item>
    <kr-grid-item>
        ...
        <a href="../knowledge-ai/knowledge-ai-introduction.md">Learn More</a>
    </kr-grid-item>
    <kr-grid-item>
        ...
        <a href="../natural-language/nlp-introduction.md">Learn More</a>
    </kr-grid-item>
    <kr-grid-item>
    ...
    <kr-grid-item>
        ...
        <a href="../testing/test-and-debug-overview.md">Learn More</a>
    </kr-grid-item>      
</kr-grid>
