...
![access feedback survey](./images/access-feedback-survey.png "access feedback survey")
...
![add feedback](./images/add-feedback.png "add feedback")
 
Otherwise, click **New Survey**.
![click new survey](./images/click-new-survey.png "click new survey")
...
![alt_text](./images/click-next-add-feedback-survey.png "image_tooltip")
...
2. If you want to create a new Feedback Survey along with a **Dialog Task** to collect the feedback and capture the analytics, follow the steps below:
    ...
    * Enter the **Dialog Name** in the text area.
    ![enter dialog name](./images/enter-the-dialog-name.png "enter dialog name")
    * Set the default **Primary Question** to be posed to the customer for the selected survey type when it’s triggered.
    ![default primary question](./images/default-primary-question.png "default primary question")
...
![nps survey](./images/nps-survey.png "NPS Survey")
...
![csat survey](./images/csat-survey.png "csat survey")

**Like/Dislike**

![like dislike survey](./images/like-dislike-survey.png "like dislike survey")
...
![survey without dialog](./images/survey-without-dialog.png "survey without dialog")
...
![enable follow-up](./images/follow-up-enable.png "enable follow-up")
...
![configure condition](./images/configure-if-condition.png "configure condition")
* Next, increment or decrement the **feedback score counter** for the selected condition to set the validation criterion.
![adjust feedback counter](./images/adjust-feedback-score-counter.png "adjust feedback counter")
* Either edit the default follow-up question in the text area provided for the **THEN** clause or keep it unchanged.
![edit default follow-up question](./images/edit-default-follow-up-question.png "edit default follow-up question")
...
![modify acknowledgement message](./images/acknowledge-message-modify.png "modify acknowledgement message")
...
1. Select one of the following options:
    ...
    * **I will decide how to launch the Survey**: You can manually initiate the feedback survey at any time by using the associated dialog task in the Kore.ai XO platform. A dialog task will be made available under Build → Conversational Skills. This allows you to control when the survey is launched and gather feedback at your own convenience.
    ![launch survey after end of task](./images/launch-survey-after-end-of-task.png "launch survey after end of task")
...
![survey creation success](./images/survey-creation-success-message.png "survey creation success")
...
![feedback service type](./images/feedback-service-type.png "feedback service type")
...
![feedback as sub-dialog](./images/feedback-as-sub-dialog.png "feedback as sub-dialog")
