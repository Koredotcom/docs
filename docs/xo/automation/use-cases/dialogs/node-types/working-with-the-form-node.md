...
2. Under the **Custom Tags** section, add tags to build custom profiles of your conversations. [Click here for more](https://developer.kore.ai/docs/bots/bot-builder-tool/dialog-task/custom-meta-tags/).
