...
Allow users to Access and Manage the Campaigns Module
  ...
  <tr>
   <td><strong>AgentAssist Module</strong>Allow user to Access and Manage AgentAssist Module
   </td>
   <td>Yes
   </td>
  </tr>
...
Manage communication channels
  ...
  <tr>
   <td><strong>Billing</strong>Manage account-level billing preferences
   </td>
   <td>None
   </td>
  </tr>
