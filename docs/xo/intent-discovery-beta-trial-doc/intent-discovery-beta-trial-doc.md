...
![Image title](../assets/images/intent-discovery/create-project.png)

<img src="/docs/xo/assets/images/intent-discovery/create-project.png" alt="Create a Project" width="75%" height="75% title="Create a Project">
