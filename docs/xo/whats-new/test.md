...
-   <img src="../images/xop-sm-uc.svg"></img>{ .lg .middle } __Define Use Cases__
   ...
   Adding a new line Use Cases are fundamental building blocks for automation. Build use cases to help specific audiences navigate well-defined steps that solve a clear intent.
